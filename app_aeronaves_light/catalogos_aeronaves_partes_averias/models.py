...
class CatalogoAeronaveParteAveria(models.Model):
    empleado 						       = models.ManyToManyField(Empleado, through='catalogos_aeronaves_partes_averias_empleados.CatalogoAeronaveParteAveriaEmpleado')
    catalogos_aeronaves_partes = models.ForeignKey(CatalogoAeronaveParte)
    ...
    def get_nombre(self):
      return ' %s | %s ' %(self.catalogos_aeronaves_partes.get_nombre() , self.averia.get_nombre())
