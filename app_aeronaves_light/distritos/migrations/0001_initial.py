    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(db_index=True, help_text='Escribir el nombre del distrito.', max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(1), django.core.validators.MaxLengthValidator(100)])),
                ('imagen', models.ImageField(blank=True, help_text='Subir imagen del distrito. (Opcional)', null=True, upload_to='imagenes_distritos')),
